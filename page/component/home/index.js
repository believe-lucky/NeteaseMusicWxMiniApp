...
Page({
  ...
  onShow: function () {
    ...
    console.log(wx.getStorage("user"),'user-++-');
    if (!wx.getStorage("user")) {
      wx.redirectTo({
        url: "../login/index",
      });
      return;
    ...
    wx.request({
      ...
      complete: function (res) {
        ...
        if (!isadd) {
          ...
          res.data.djRadios = that.data.djlist.list.djRadios.concat(
            res.data.djRadios
          );
          that.data.djlist.list = res.data;
        }
    ...
    wx.request({
      ...
      complete: function (res) {
        ...
        if (!isadd) {
          ...
          res.data.playlists = that.data.playlist.list.playlists.concat(
            res.data.playlists
          );
          that.data.playlist.list = res.data;
        }
